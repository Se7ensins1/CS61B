...
public class Parse {
    ...
    private static void createNewTable(String name, String[] cols) {
        ...
        System.out.printf("You are trying to create a table named %s with" +
                "the columns %s\n", name, colSentence);
    }

    private static void createSelectedTable(String name, String exprs,
                                            String tables, String conds) {
        System.out.printf("You are trying to create a table named %s by selecting"
                + "these expressions: '%s' from the join of these tables: '%s', filtered"
    ...
    private static void insertRow(String expr) {
        ...
        System.out.printf("You are trying to insert the row \"%s\" into the"
                + "table %s\n", m.group(2), m.group(1));
    }
    ...
    private static void select(String exprs, String tables, String conds) {
        System.out.printf("You are trying to select these expressions:"
                + " '%s' from the join of these tables: '%s', filtered by these"
                + "conditions: '%s'\n", exprs, tables, conds);
    }
}
